...
--
-- Host: localhost:3306
-- Generation Time: Jan 24, 2024 at 09:32 AM
...
--
-- Table structure for table `ex_uploads`
--

CREATE TABLE `ex_uploads` (
  `id` int(11) NOT NULL,
  `docs` text,
  `images` text,
...
--
-- Dumping data for table `ex_uploads`
--

INSERT INTO `ex_uploads` (`id`, `docs`, `images`, `ref`) VALUES
(1, '{\"35e90f728b3805677fc4b01dc45d0bc0.docx\":\"FM-QC-13 Rev.08 0022.24 - อรอนงค์ ชุมภู.docx\"}', NULL, 'B7-iNrRhFUFxZwlJhFSQ_X'),
(2, '{\"7f97fa62ce77043aa8647772a7e17b11.pdf\":\"ประกาศ กำหนดวันหยุดตามประเพณี ปี 2567-CEI.pdf_1.pdf\",\"477d9aae81aa9efdb0fc560f038d5e05.pdf\":\"ถั่วเหลือง Organic FT. - อุ่มแสง.pdf\"}', NULL, '_I7sdxbhHm31JKrVN0Xs-J');
...
--
-- Dumping data for table `it_ex_upload`
--

INSERT INTO `it_ex_upload` (`id`, `title`, `img_ref`, `doc_ref`) VALUES
(5, 'asdadas', 'lcBUbTAWfv5VAnuJs1ES5z', NULL),
(6, 'dasdas', 'MrjtmPvaLNQ13XwYV5rg7i', NULL),
(7, 'asdasd', '8eJeFpCe_gKFWfriL4zaUo', NULL),
(8, 'asdasd', 'QSoXqKoBDq45Bqg9oMocmf', NULL);
...
CREATE TABLE `ncr` (
  ...
  `action` text COMMENT 'การดำเนินการเบื้องต้น',
...
(1, 1, 'N-6701-027', '2024-01-23', 1, 2, 8, 'FG,Claim', 'cs-007/24', '2024-01-16', 'Or.Mirin 5.5 %-200 ML', 'John Doe', 2, 1, 'ปริมาณเชื้อ Colifrom เกินมาตรฐาน มาตรฐาน Colifrom =0', 11, 12, 'ตรวจซ้ำ', '', '9IAJ7Yhrp-LyKXIt72pryA', '2024-01-23', 12, '2024-01-24', 12),
(2, 2, 'N-6701-028', '2024-01-24', 1, 2, 8, NULL, '028/24', '2024-01-12', 'Organic 10 L', '', 1, 1, 'TN ต่ำกว่ามาตรฐาน : 1.05 (Spec 1.15-1.19),pH ต่ำกว่ามาตรฐาน : 4.51 (Spec 4.70-5.00),Color เข้มกว่ามาตรฐาน : 7 (Spec 9-15)\r\nข้อมูลการไล่ท่อ pH : 4.50, Nacl : 17.05 , Brix : 30.6 , TN : 1.05 , Alc: 1.64 , SG : 1.137, Color : 7', 11, 12, '', '', 'fcyONe-gsWBW9inofWKeNN', '2024-01-24', 12, '2024-01-24', 12),
(3, 2, 'N-6701-029', '2024-01-24', 1, 2, 8, 'Incoming,Claim', '030/24', '2024-01-22', 'Rich 18 lit', 'QP', 1, 2, 'Color เข้มกว่ามาตรฐาน : 7 (Spec 9-15)\r\nข้อมูลการไล่ท่อ pH : 4.81, Nacl : 17.56 , Brix : 37.4 , TN : 1.80 , Alc: 0.82 , SG : 1.167, Color : 7\r\n', 11, 12, '', '', 'tfeeersqyV6E_x5ZLp2_1n', '2024-01-24', 12, '2024-01-24', 12);

-- --------------------------------------------------------

--
-- Table structure for table `ncr_accept`
--

CREATE TABLE `ncr_accept` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ncr_cause`
--

CREATE TABLE `ncr_cause` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `ncr_closing`
--
...
CREATE TABLE `ncr_process` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL COMMENT 'กระบวนการ',
  `color` varchar(45) DEFAULT NULL COMMENT 'สี',
  `active` int(11) DEFAULT '1' COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ncr_reply`
--
...
(1, 1, 1, 10, 'กล่อง', '', '2024-01-24', 12, 5, '2024-01-24', '', ''),
(2, 1, 1, 20, 'ขวด', '', '2024-01-24', 12, 4, '2024-01-24', '', ''),
(3, 2, 5, 8, 'แพ็ค', '', '2024-01-24', 15, 4, '2024-01-24', '', ''),
(4, 2, 3, 5, 'ลัง', 'ทดสอบ', '2024-01-24', 12, 4, '2024-01-24', '', ''),
(5, 3, 1, 44, '44', '4444', '2024-01-24', 12, 10, '2024-01-18', '', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `ncr_reply_type`
--

CREATE TABLE `ncr_reply_type` (
  `id` int(11) NOT NULL,
  `name` varchar(100) DEFAULT NULL COMMENT 'ชื่อ',
  `color` varchar(45) DEFAULT NULL COMMENT 'สี',
  `active` int(11) DEFAULT '1' COMMENT 'สถานะ'
...
INSERT INTO `ncr_status` (`id`, `name`, `color`, `active`) VALUES
(1, 'Open', '#B31312', 1),
(2, 'Reply', '#EE7214', 1),
(3, 'Protect', '#11009E', 1),
(4, 'Accept', '#D24545', 1),
...
INSERT INTO `ncr_sub_category` (`id`, `name`, `color`, `active`) VALUES
(1, 'YM', '#711DB0', 1),
(2, 'BA', '#C21292', 1),
(3, 'SA', '#EF4040', 1);
...
(1, 'B7-iNrRhFUFxZwlJhFSQ_X', '393599268_828804315609755_7478797839013769849_n.jpg', '450475cc3740e75eaf69832aa917cdd3.jpg', '2024-01-19 08:27:37', NULL),
(2, 'B7-iNrRhFUFxZwlJhFSQ_X', '393606033_828804218943098_686037007461913561_n.jpg', '7e66aee8e95849972b1695149c5779fc.jpg', '2024-01-19 08:27:37', NULL),
(4, 'B7-iNrRhFUFxZwlJhFSQ_X', 'test.jpg', '6438599a72063a957b3a61f4ad4cd9c4.jpg', '2024-01-19 08:31:56', NULL),
(5, '_I7sdxbhHm31JKrVN0Xs-J', '399270941_839974414492745_6230710593654371983_n.jpg', 'b7840333c9e58d0834617e6e25f04c74.jpg', '2024-01-19 08:47:08', NULL),
(7, '_I7sdxbhHm31JKrVN0Xs-J', 'pexels-photo-378570.jpeg', 'a0e6e021b8625a01dc7430f3dc814377.jpeg', '2024-01-19 08:54:46', NULL),
(8, '_I7sdxbhHm31JKrVN0Xs-J', 'test.jpg', 'c86158d688124df840618d6bf9b33105.jpg', '2024-01-19 08:54:46', NULL);
...
INSERT INTO `upload_img` (`upload_id`, `ref`, `file_name`, `real_filename`, `create_date`, `type`) VALUES
(4, 'KcmmPH3ZR9g_R96HLfjqoh', '409704283_7696165117064192_6198551449810247377_n.jpg', '956d3fe89a4d9d1cfc3a8024ea59e32c.jpg', '2024-01-10 01:54:34', NULL),
(5, 'lcBUbTAWfv5VAnuJs1ES5z', 'screencapture-localhost-app-dcms-web-operator-auto-number-index-2023-06-12-14_30_40.png', '93aa61f81cd9168a76f235d8afb2974e.png', '2024-01-10 02:14:46', NULL),
(6, 'lcBUbTAWfv5VAnuJs1ES5z', 'screencapture-localhost-app-dcms-web-operator-report-index-2023-06-12-14_37_41.png', '579bac177f64688439c1c627fd9bf8c3.png', '2024-01-10 02:14:46', NULL),
(7, 'lcBUbTAWfv5VAnuJs1ES5z', '409704283_7696165117064192_6198551449810247377_n.jpg', '0332a826c5778c2c071f73242e0f6943.jpg', '2024-01-10 02:25:33', NULL),
(8, 'QSoXqKoBDq45Bqg9oMocmf', '417128958_872975007859352_1063872905675882642_n.jpg', '0742c4df5a08e3c939283437ee83ef2c.jpg', '2024-01-15 07:06:10', NULL),
(9, 'QSoXqKoBDq45Bqg9oMocmf', '399270941_839974414492745_6230710593654371983_n.jpg', 'f4729576e3af5991cc4a926c66106572.jpg', '2024-01-15 07:06:10', NULL);
...
--
-- Indexes for table `ex_uploads`
--
ALTER TABLE `ex_uploads`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ncr_cause`
--
ALTER TABLE `ncr_cause`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ncr_closing`
--
...
--
-- Indexes for table `ncr_reply`
--
ALTER TABLE `ncr_reply`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_ncr_reply_ncr_reply_type1_idx` (`reply_type_id`),
  ADD KEY `fk_ncr_reply_ncr1_idx` (`ncr_id`);

--
-- Indexes for table `ncr_reply_type`
--
...
--
-- AUTO_INCREMENT for table `ex_uploads`
--
ALTER TABLE `ex_uploads`
...
--
-- Constraints for table `ncr_accept`
--
ALTER TABLE `ncr_accept`
  ADD CONSTRAINT `fk_ncr_accept_ncr1` FOREIGN KEY (`ncr_id`) REFERENCES `ncr` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ncr_solving_ncr_concession10` FOREIGN KEY (`ncr_concession_id`) REFERENCES `ncr_concession` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `ncr_reply`
  ADD CONSTRAINT `fk_ncr_reply_ncr1` FOREIGN KEY (`ncr_id`) REFERENCES `ncr` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ncr_reply_ncr_reply_type1` FOREIGN KEY (`reply_type_id`) REFERENCES `ncr_reply_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
