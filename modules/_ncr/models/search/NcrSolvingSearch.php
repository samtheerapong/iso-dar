...
/**
 * NcrSolvingSearch represents the model behind the search form of `app\modules\ncr\models\NcrSolving`.
 */
class NcrSolvingSearch extends NcrSolving
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['unit', 'proceed', 'operation_date', 'process', 'cause', 'approve_date'], 'safe'],
        ];
    }
