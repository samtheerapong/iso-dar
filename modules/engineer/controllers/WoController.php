...
use app\modules\engineer\models\search\WoSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * WoController implements the CRUD actions for Wo model.
 */
class WoController extends Controller
{
    ...
    {
        if (($model = Wo::findOne(['id' => $id])) !== null) {
            return $model;
        }
