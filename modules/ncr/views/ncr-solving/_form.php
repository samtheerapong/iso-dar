...
<div class="ncr-solving-form">
    ...
    <div class="card border-secondary">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    <?= $form->field($model, 'solving_type_id')->widget(Select2::class, [
                ...
                <div class="col-md-12">
                    <?= $form->field($model, 'proceed')->textInput(['maxlength' => true]) ?>
                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    <?= $form->field($model, 'ncr_concession_id')->widget(Select2::class, [
                ...
                <div class="col-md-3">
                    <?= $form->field($model, 'customer_name')->textInput(['value' => $model->customer_name]) ?>
                </div>
                ...
                <div class="col-md-3">
                    <?= $form->field($model, 'approve_name')->widget(Select2::class, [
                        'data' => ArrayHelper::map(User::find()->where(['rule_id' => 8])->all(), 'id', 'thai_name'),
                        'options' => ['placeholder' => Yii::t('app', 'Select...')],
                        'pluginOptions' => [
                            'allowClear' => true
